...
class App extends Component {
  state = { loaded: false, kycAddress: "0x123...", tokekSaleAddress: null, userTokens: 0 };
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <h2>Buy Tokens</h2>
        <p>Please send Wei to the following address: {this.state.tokenSaleAddress}</p>
